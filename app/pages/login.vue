...
const toggleVisibility = () => {
  ...
  toggleFill.value = toggleFill.value === "black" ? "blue" : "black";
};
</script>
<template>
  <form class="flex justify-center gap-10" @submit.prevent="handleLogin">
    ...
    <div>
      ...
      <div class="relative">
        <input class="border-black border-2" :type="passwordInputType" id="password" v-model="password" />
        <div class="absolute right-1 h-4 w-4 top-1/2 -translate-1/2" @click="toggleVisibility">
